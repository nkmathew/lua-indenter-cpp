...
// ____________________________Structures and Global Variables__________________________
...
// ____________________________Function Prototypes______________________________________
...
void indent_code(std::string *raw_code, std::fstream *indented_file) {
    ...
    for (int offset = 0; offset < line_length; offset++) {
      ...
      if (in_single_quoted_string || in_double_quoted_string || in_long_string
        ...
        if ((equals_any(prev_char, "\t ><=+-*/^(){;,\"']") || prev_char == "") &&
          ...
          // ______________________________extract token___________________________________________
          ...
          if (is_increaser(&token) && token != "") {
            ...
            // __________Handle extended for/while constructs___________________
      ...
      // __________________Handle Long comments/strings______--[[   ]]_________
  ...
  // ___________________________Issue warnings_______________________________________
  if (in_long_string) {
